...
HD_PWD='C:/Users/ThD/Desktop/com_con/connection_already/SCPU_TOP.runs/dist_mem_im_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dist_mem_im.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dist_mem_im.tcl
