...
HD_PWD='C:/Users/ThD/Desktop/com_con/guess_number/guess_number.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log guess_number_pro.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source guess_number_pro.tcl -notrace
