...
HD_PWD='C:/Users/ThD/Desktop/com_con/guess_number/guess_number.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log guess_number_pro.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source guess_number_pro.tcl
